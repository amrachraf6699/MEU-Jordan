    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                <h6>جدول البرامج ({{ $programs->total() }})</h6>
            ...
            <div class="card-body px-0 pt-0 pb-2">
                <div class="table-responsive p-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <!-- Edit Link -->
                                    <a href="{{ route('dashboard.programs.edit', $program) }}" class="text-info font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit program">
                                        تعديل
                                    </a>
                                    ...
                                    <!-- Delete Form -->
                                    <form action="{{ route('dashboard.programs.destroy', $program->id) }}" method="POST" style="display:inline;" id="delete-form-{{ $program->id }}">
                                        @csrf
                                        @method('DELETE')
                    ...
                    <div class="d-flex justify-content-center mt-4">
                        {{ $programs->appends(request()->query())->links('pagination::bootstrap-4') }}
                    </div>
                </div>
            </div>
        </div>
